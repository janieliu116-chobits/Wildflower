...
import { gatherConsentAndInitializeAdsSdk } from '@/utils/ads';
import { getNotificationSettings, scheduleDailyNotification } from '@/utils/notifications';

SplashScreen.preventAutoHideAsync();

// Fire-and-forget: gathers EEA/UK privacy consent (required by Google's UMP
// policy) and only then initializes the Google Mobile Ads SDK, so it's
// ready -- and compliant -- before the Ask tab's first interstitial is
// requested. See utils/ads.ts.
gatherConsentAndInitializeAdsSdk();
