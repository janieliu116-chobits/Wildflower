...
interface SliderTabsProps {
  ...
  matchThemeFilterSize?: boolean;
}

export default function SliderTabs({ tabs, activeId, onChange, matchThemeFilterSize = false }: SliderTabsProps) {
        ...
        return (
          ...
          >
            ...
            <Text
              style={[
                styles.tabText,
                matchThemeFilterSize && styles.themeFilterText,
